...
- [ ] 1. Backend project structure and environment configuration
  ...
  - Install backend dependencies: `@apollo/server`, `express`, `graphql`, `@graphql-tools/schema`, `@prisma/client`, `prisma`, `dotenv`, `fast-check` (dev)
...
- [ ] 2. Prisma schema and initial migration
  ...
  - [ ]* 2.2 Write unit test for schema provider-compatibility
...
- [ ] 3. PrismaClient singleton and SQLite PRAGMA initialisation
  ...
  - [ ]* 3.2 Write unit tests for PrismaClient singleton
...
- [ ] 4. Configuration loader with fail-fast validation
  ...
  - [ ]* 4.2 Write unit tests for config loader
...
- [ ] 5. Operation_Queue (serial FIFO write queue)
  ...
  - [ ] 5.2 Implement passthrough queue for MySQL
    ...
    - _Requirements: 4.6_
  - [ ]* 5.3 Write property test for Operation_Queue serialisation order (Property 3)
  ...
  - [ ]* 5.4 Write property test for Operation_Queue queue-full rejection (Property 4)
  ...
  - [ ]* 5.5 Write unit tests for Operation_Queue
...
- [ ] 7. Error handling module
  ...
  - [ ]* 7.3 Write property test for error extensions.code (Property 1)
  ...
  - [ ]* 7.4 Write unit tests for error mapping
...
- [ ] 9. Service layer (transaction boundaries)
  ...
  - [ ] 9.3 Implement service functions for Combatant, StatBlock, Inventory, and Item
    ...
    - _Requirements: 2.8, 6.1, 6.4_
  - [ ]* 9.4 Write property test for transaction atomicity (Property 5)
...
- [ ] 10. GraphQL resolvers
  ...
  - [ ] 10.3 Implement resolvers for Combatant, StatBlock, Inventory, and Item
    ...
    - _Requirements: 1.3_
  - [ ]* 10.4 Write property test for auth rejection (Property 2)
  ...
  - [ ]* 10.5 Write unit tests for resolvers
...
- [ ] 12. Express app, Apollo Server, and health endpoint
  ...
  - [ ] 12.2 Implement graceful shutdown handler
    ...
    - _Requirements: 4.7_
  - [ ]* 12.3 Write property test for graceful shutdown drain (Property 6)
  ...
  - [ ]* 12.4 Write integration tests for health endpoint and GraphQL round-trip
...
- [ ] 14. Final checkpoint — full test suite
  - Run `npm run test:run` and confirm all unit tests, property-based tests (Properties 1–6), and integration tests pass with zero failures. Ask the user if questions arise.

---

## Notes

- Tasks marked with `*` are optional and can be skipped for a faster MVP, but all six property-based tests (Properties 1–6) are strongly recommended before shipping.
